...
const { checkProjectId, checkProjectContents } = require('../middleware/middleware');
...
router.post('/', checkProjectContents, (req, res) => {
...
router.put('/:id', checkProjectId, checkProjectContents, (req, res) => {
